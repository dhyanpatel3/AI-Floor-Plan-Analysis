      ...
      >
        {selectedPlan && (
          <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900/50">
            {/* Toolbar / Tabs */}
            <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 shrink-0 sticky top-0 z-10">
              <div className="flex bg-slate-100 dark:bg-slate-700/50 p-1 rounded-lg self-start md:self-auto">
                <button
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 text-sm font-medium text-white rounded-lg shadow-md transition-all hover:shadow-lg transform active:scale-95 ${
                  isDownloading
